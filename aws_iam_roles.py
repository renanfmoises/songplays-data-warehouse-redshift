...
def attach_role_policy(iam_client, role_name):
    ...
    try:
        print(
            f"Attaching the IAM policy named dwhRolePolicy to the IAM role {role_name}..."
        )
        ...
        if e.response["Error"]["Code"] == "InvalidInput":
            print(
                f"The IAM policy named dwhRolePolicy is already attached to the IAM role {role_name}."
            )
        else:
            raise
    else:
        print(
            f"The IAM policy named dwhRolePolicy has been attached to the IAM role {role_name}."
        )
...
def detach_role_policy(iam_client, role_name):
    ...
    try:
        print(
            f"Detaching the IAM policy named dwhRolePolicy from the IAM role {role_name}..."
        )
        ...
        if e.response["Error"]["Code"] == "InvalidInput":
            print(
                f"The IAM policy named dwhRolePolicy is not attached to the IAM role {role_name}."
            )
        else:
            raise
    else:
        print(
            f"The IAM policy named dwhRolePolicy has been detached from the IAM role {role_name}."
        )
